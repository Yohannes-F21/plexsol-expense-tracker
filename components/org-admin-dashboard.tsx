...
import { Users, Receipt, Clock, CheckCircle, DollarSign, UserPlus } from "lucide-react"
...
export function OrgAdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
                      ...
                      <div key={expense.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex-1">
                          ...
                          <div className="flex gap-4 mt-2 text-sm text-muted-foreground">
                            <span>By: {expense.user.name || expense.user.email}</span>
      ...
      <InviteUserDialog open={showInviteDialog} onOpenChange={setShowInviteDialog} onSuccess={fetchData} />
    </div>
  )
}
