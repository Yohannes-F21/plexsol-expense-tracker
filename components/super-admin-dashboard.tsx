...
import { Building2, Users, Receipt, Clock, DollarSign, Plus } from "lucide-react"
                  ...
                  <div key={org.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-sm text-muted-foreground text-right">
                        ...
                        <div className="text-xs">Created by {org.createdBy.name}</div>
                      </div>
                      <Button variant="outline" size="sm" onClick={() => handleInviteAdmin(org.id)}>
                        Invite Admin
                      </Button>
                    </div>
                  </div>
