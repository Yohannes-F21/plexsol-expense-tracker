...
export function UnitsOfMeasureManagement() {
  ...
  const unitsQuery = useQuery<{ units: Unit[] }>({
    queryKey: [...UNITS_QUERY_KEY, searchTerm],
    queryFn: async () => {
      ...
      const url = qs
        ? `/api/org-admin/units-of-measure?${qs}`
        : "/api/org-admin/units-of-measure";
                ...
                <TableRow>
                  <TableCell colSpan={columns.length}>
                    <div className="flex items-center justify-center py-8">
                      <Loader size="md" ariaLabel="Loading units" showLabel />
                    </div>
                  </TableCell>
                </TableRow>
